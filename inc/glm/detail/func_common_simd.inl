...
namespace glm {
    namespace detail {
        ...
        struct compute_clamp_vector<4, int, Q, true> {
            ...
            call(vec<4, int, Q> const &x, vec<4, int, Q> const &minVal, vec<4, int, Q> const &maxVal) {
                vec<4, int, Q> result;
        ...
        struct compute_clamp_vector<4, uint, Q, true> {
            ...
            call(vec<4, uint, Q> const &x, vec<4, uint, Q> const &minVal, vec<4, uint, Q> const &maxVal) {
                vec<4, uint, Q> result;
